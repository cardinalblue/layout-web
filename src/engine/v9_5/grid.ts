...
// ============================================================
// Mutation — spec 0423-1 §Grid Layout → Mutation Operators
// Compound: every offspring gets one tree op (flipCut 40% /
// swapLeaves 30% / restructure 30%), plus an additive per-text-
// item 50% ratio-resample pass when enableRatioMutation is on.
// ============================================================
