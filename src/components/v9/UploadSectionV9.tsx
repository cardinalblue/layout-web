...
import type { LayoutV9Input, TextRenderOpts, TextScrapInput } from '../../engine/v9/types';
...
import { photosEqual, type StagedPhoto } from './stagedPhotos';
import ParameterPanelV9, { DEFAULT_PARAMS_V9, type ParamsV9 } from './ParameterPanelV9';
import DualCanvasView from './DualCanvasView';
import SamplePhotoPicker from './SamplePhotoPicker';
import GenerateLayoutButton from './GenerateLayoutButton';
...
export default function UploadSectionV9() {
  ...
  return (
    <section
      ...
      aria-labelledby="upload-v9-title"
    >
      <h2
        id="upload-v9-title"
