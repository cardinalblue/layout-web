...
import type { Item, TextRenderOpts } from '../../engine/v9_5/types';
import { genItems } from '../../engine/v9_5/items';
import { runGA } from '../../engine/v9_5/grid';
import { bestPhyllo } from '../../engine/v9_5/phyllo';
import { normalizedCanvas } from '../../engine/v9_5/shared';
import CanvasViewV9 from '../v9/CanvasViewV9';
...
function AlgorithmCardV2_5({ mode }: CardProps) {
...
export default function AlgorithmIntroV2_5() {
  return (
    <section
      className="mx-auto w-full px-4 sm:px-6 lg:px-8"
      style={{ maxWidth: '960px' }}
      aria-labelledby="algo-intro-v2-5-title"
    >
      <h2
        id="algo-intro-v2-5-title"
      ...
      <div className="flex flex-col gap-6 sm:flex-row">
        <AlgorithmCardV2_5 mode="grid" />
        <AlgorithmCardV2_5 mode="phyllo" />
      </div>
    </section>
  );
}
