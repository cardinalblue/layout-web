...
import type { TextRenderOpts } from '../../engine/v9_5/types';
...
export default function AnimatedDemoV2_5() {
  const [isGrid, setIsGrid] = useState(true);
  // Client-only gate: SSR renders a placeholder, the GA-driven canvas
  // renders after mount. Avoids hydration mismatches from float-order
  // non-determinism between Node SSR and the browser over 50×40 GA draws.
